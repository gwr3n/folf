...
- Clarified the README description around Edmundson-Madansky upper bounds and
	Jensen-based lower bounds for mixed-integer linear optimization models.
- Added the foundational paper citation and publication details to the README.
- Removed internal utility modules from the README's user-facing feature list.
